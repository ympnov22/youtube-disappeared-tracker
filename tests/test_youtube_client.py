...
class TestYouTubeClient:
    @pytest.fixture
    def mock_youtube_service(self) -> Generator[Mock, None, None]:
    ...
    @pytest.fixture
    def youtube_client(self, mock_youtube_service: Mock) -> YouTubeClient:
    ...
    def test_extract_channel_id_direct_channel_id(
    ...
    def test_extract_channel_id_channel_url(
        self, youtube_client: YouTubeClient
    ) -> None:
    ...
    def test_extract_channel_id_channel_url_with_trailing_slash(
        self, youtube_client: YouTubeClient
    ) -> None:
        url = "https://www.youtube.com/channel/UCrAOnWiW_Q1w5UhKjZhOJmA/"
        result = youtube_client._extract_channel_id(url)
    ...
    def test_extract_channel_id_invalid_format(
        self, youtube_client: YouTubeClient
    ) -> None:
        invalid_inputs = [
            "invalid-channel-id",
    ...
    def test_resolve_channel_input_direct_channel_id(
        self, youtube_client: YouTubeClient, mock_youtube_service: Mock
    ) -> None:
        channel_id = "UCrAOnWiW_Q1w5UhKjZhOJmA"
    ...
    def test_resolve_channel_input_handle(
        self, youtube_client: YouTubeClient, mock_youtube_service: Mock
    ) -> None:
        handle = "@testhandle"
        channel_id = "UCrAOnWiW_Q1w5UhKjZhOJmA"
    ...
    def test_resolve_channel_input_user_url(
        self, youtube_client: YouTubeClient, mock_youtube_service: Mock
    ) -> None:
    ...
    def test_extract_metadata_complete(self, youtube_client: YouTubeClient) -> None:
    ...
    def test_extract_metadata_minimal(self, youtube_client: YouTubeClient) -> None:
        channel_data: Dict[str, Any] = {
            "snippet": {},
            "statistics": {},
            "contentDetails": {},
